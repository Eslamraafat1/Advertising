...
const awardsData = {
  ar: {
    ...
    testimonial: "\"وكالة AdVision غيّرت مسار نمونا بشكل جذري. في 6 أشهر فقط حقّقنا ما لم نكن نحلم به خلال سنوات.\"",
  ...
  en: {
    ...
    testimonial: "\"AdVision radically changed our growth trajectory. In just 6 months, we achieved what we couldn't dream of in years.\"",
